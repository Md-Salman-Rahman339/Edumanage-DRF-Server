...
urlpatterns = [
    ...
    # path('token/exchange/', FirebaseTokenExchangeView.as_view(), name='token_exchange'),
    ...
    path('admin/<str:email>/', CheckAdminView.as_view(), name='check-admin'),
    path('teacher/<str:email>/', CheckTeacherView.as_view(), name='check-teacher'),
